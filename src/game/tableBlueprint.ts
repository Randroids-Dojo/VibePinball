...
export const silverballSocialBlueprint: TableBlueprint = {
  ...
  shots: [
    { id: "shot.left-orbit", label: "Left orbit", primaryFlipper: "right", deviceIds: ["playfield.art.left-orbit-arrow", "orbit.left.entry", "handoff.left-orbit-entry.inner-guide", "handoff.left-orbit-entry.outer-guide", "orbit.left.exit", "handoff.upper-orbit-gates.left", "lane.top.left", "rollover.top.left", "lane.top.left.guide-cover", "lane.top.left.rubber-band", "pop-a"] },

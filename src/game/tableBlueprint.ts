...
export const silverballSocialBlueprint: TableBlueprint = {
  ...
  shots: [
    ...
    { id: "shot.right-orbit", label: "Right orbit", primaryFlipper: "left", deviceIds: ["playfield.art.right-orbit-arrow", "orbit.right.entry", "handoff.right-orbit-entry.inner-guide", "handoff.right-orbit-entry.outer-guide", "orbit.right.outer.lower", "orbit.right.inner.lower", "orbit.right.outer.mid", "orbit.right.inner.mid", "orbit.right.outer.upper", "orbit.right.inner.upper", "boundary.top-arch.right-curve", "boundary.top-arch.center", "boundary.top-arch.left-curve", "orbit.right.exit", "handoff.upper-orbit-gates.right", "wireform.right-orbit-return.upper.rail-left", "wireform.right-orbit-return.upper.rail-right", "wireform.right-orbit-return.lower.rail-left", "wireform.right-orbit-return.lower.rail-right", "wireform.right-orbit-return.support.upper", "wireform.right-orbit-return.support.upper.cap", "wireform.right-orbit-return.support.upper.foot", "wireform.right-orbit-return.support.upper.foot.screw-left", "wireform.right-orbit-return.support.upper.foot.screw-right", "wireform.right-orbit-return.support.upper.collar", "wireform.right-orbit-return.support.upper.saddle", "wireform.right-orbit-return.support.upper.saddle.screw-left", "wireform.right-orbit-return.support.upper.saddle.screw-right", "wireform.right-orbit-return.support.mid", "wireform.right-orbit-return.support.mid.cap", "wireform.right-orbit-return.support.mid.foot", "wireform.right-orbit-return.support.mid.foot.screw-left", "wireform.right-orbit-return.support.mid.foot.screw-right", "wireform.right-orbit-return.support.mid.collar", "wireform.right-orbit-return.support.mid.saddle", "wireform.right-orbit-return.support.mid.saddle.screw-left", "wireform.right-orbit-return.support.mid.saddle.screw-right", "wireform.right-orbit-return.support.exit", "wireform.right-orbit-return.support.exit.cap", "wireform.right-orbit-return.support.exit.foot", "wireform.right-orbit-return.support.exit.foot.screw-left", "wireform.right-orbit-return.support.exit.foot.screw-right", "wireform.right-orbit-return.support.exit.collar", "wireform.right-orbit-return.support.exit.saddle", "wireform.right-orbit-return.support.exit.saddle.screw-left", "wireform.right-orbit-return.support.exit.saddle.screw-right", "wireform.right-orbit-return.exit", "handoff.right-orbit-exit.left-guide", "handoff.right-orbit-exit.right-guide"] },

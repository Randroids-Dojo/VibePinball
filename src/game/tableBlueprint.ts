...
export const silverballSocialBlueprint: TableBlueprint = {
  ...
  shots: [
    { id: "shot.left-orbit", label: "Left orbit", primaryFlipper: "right", deviceIds: ["playfield.art.left-orbit-arrow", "orbit.left.entry", "handoff.left-orbit-entry.inner-guide", "handoff.left-orbit-entry.outer-guide", "orbit.left.outer.lower", "orbit.left.inner.lower", "orbit.left.outer.mid", "orbit.left.inner.mid", "orbit.left.outer.upper", "orbit.left.inner.upper", "orbit.left.exit", "handoff.upper-orbit-gates.left", "lane.top.left", "rollover.top.left", "lane.top.left.guide-cover", "lane.top.left.rubber-band", "pop-a"] },
    ...
    { id: "shot.right-orbit", label: "Right orbit", primaryFlipper: "left", deviceIds: ["playfield.art.right-orbit-arrow", "orbit.right.entry", "handoff.right-orbit-entry.inner-guide", "handoff.right-orbit-entry.outer-guide", "orbit.right.outer.lower", "orbit.right.inner.lower", "orbit.right.outer.mid", "orbit.right.inner.mid", "orbit.right.outer.upper", "orbit.right.inner.upper", "orbit.right.exit", "handoff.upper-orbit-gates.right", "wireform.right-orbit-return.upper.rail-left", "wireform.right-orbit-return.upper.rail-right", "wireform.right-orbit-return.lower.rail-left", "wireform.right-orbit-return.lower.rail-right", "wireform.right-orbit-return.exit", "handoff.right-orbit-exit.left-guide", "handoff.right-orbit-exit.right-guide"] },

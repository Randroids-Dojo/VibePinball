...
export const silverballSocialBlueprint: TableBlueprint = {
  ...
  shots: [
    ...
    { id: "shot.left-ramp", label: "Left ramp", primaryFlipper: "right", deviceIds: ["playfield.art.left-ramp-arrow", "ramp.left", "ramp.left.entry", "ramp.left.entrance-lip", "ramp.left.entrance-lip.screw-a", "ramp.left.entrance-lip.screw-b", "ramp.left.side-wall.left", "ramp.left.side-wall.left.rivet-lower", "ramp.left.side-wall.left.rivet-mid", "ramp.left.side-wall.left.rivet-upper", "ramp.left.side-wall.right", "ramp.left.side-wall.right.rivet-lower", "ramp.left.side-wall.right.rivet-mid", "ramp.left.side-wall.right.rivet-upper", "ramp.left.side-rail.left", "ramp.left.side-rail.left.clamp-lower", "ramp.left.side-rail.left.clamp-mid", "ramp.left.side-rail.left.clamp-upper", "ramp.left.side-rail.right", "ramp.left.side-rail.right.clamp-lower", "ramp.left.side-rail.right.clamp-mid", "ramp.left.side-rail.right.clamp-upper", "ramp.left.cross-brace.lower", "ramp.left.cross-brace.lower.screw-left", "ramp.left.cross-brace.lower.screw-right", "ramp.left.cross-brace.mid", "ramp.left.cross-brace.mid.screw-left", "ramp.left.cross-brace.mid.screw-right", "ramp.left.cross-brace.upper", "ramp.left.cross-brace.upper.screw-left", "ramp.left.cross-brace.upper.screw-right", "ramp.left.support.entry", "ramp.left.support.entry.cap", "ramp.left.support.entry.foot", "ramp.left.support.entry.foot.screw-left", "ramp.left.support.entry.foot.screw-right", "ramp.left.support.entry.collar", "ramp.left.support.entry.saddle", "ramp.left.support.entry.saddle.screw-left", "ramp.left.support.entry.saddle.screw-right", "ramp.left.support.lower", "ramp.left.support.lower.cap", "ramp.left.support.lower.foot", "ramp.left.support.lower.foot.screw-left", "ramp.left.support.lower.foot.screw-right", "ramp.left.support.lower.collar", "ramp.left.support.lower.saddle", "ramp.left.support.lower.saddle.screw-left", "ramp.left.support.lower.saddle.screw-right", "ramp.left.support.mid", "ramp.left.support.mid.cap", "ramp.left.support.mid.foot", "ramp.left.support.mid.foot.screw-left", "ramp.left.support.mid.foot.screw-right", "ramp.left.support.mid.collar", "ramp.left.support.mid.saddle", "ramp.left.support.mid.saddle.screw-left", "ramp.left.support.mid.saddle.screw-right", "ramp.left.support.crest", "ramp.left.support.crest.cap", "ramp.left.support.crest.foot", "ramp.left.support.crest.foot.screw-left", "ramp.left.support.crest.foot.screw-right", "ramp.left.support.crest.collar", "ramp.left.support.crest.saddle", "ramp.left.support.crest.saddle.screw-left", "ramp.left.support.crest.saddle.screw-right", "handoff.ramp-left-entry.flap", "handoff.ramp-left-entry.left-guide", "handoff.ramp-left-entry.right-guide", "ramp.left.exit", "wireform.left-return.upper.rail-left", "wireform.left-return.upper.rail-right", "wireform.left-return.lower.rail-left", "wireform.left-return.lower.rail-right", "wireform.left-return.support.upper", "wireform.left-return.support.upper.cap", "wireform.left-return.support.upper.foot", "wireform.left-return.support.upper.foot.screw-left", "wireform.left-return.support.upper.foot.screw-right", "wireform.left-return.support.upper.collar", "wireform.left-return.support.upper.saddle", "wireform.left-return.support.upper.saddle.screw-left", "wireform.left-return.support.upper.saddle.screw-right", "wireform.left-return.support.mid", "wireform.left-return.support.mid.cap", "wireform.left-return.support.mid.foot", "wireform.left-return.support.mid.foot.screw-left", "wireform.left-return.support.mid.foot.screw-right", "wireform.left-return.support.mid.collar", "wireform.left-return.support.mid.saddle", "wireform.left-return.support.mid.saddle.screw-left", "wireform.left-return.support.mid.saddle.screw-right", "wireform.left-return.support.exit", "wireform.left-return.support.exit.cap", "wireform.left-return.support.exit.foot", "wireform.left-return.support.exit.foot.screw-left", "wireform.left-return.support.exit.foot.screw-right", "wireform.left-return.support.exit.collar", "wireform.left-return.support.exit.saddle", "wireform.left-return.support.exit.saddle.screw-left", "wireform.left-return.support.exit.saddle.screw-right", "wireform.left-return.exit", "handoff.ramp-left-exit.left-guide", "handoff.ramp-left-exit.right-guide"] },

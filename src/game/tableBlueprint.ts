...
export const silverballSocialBlueprint: TableBlueprint = {
  ...
  shots: [
    ...
    { id: "shot.right-orbit", label: "Right orbit", primaryFlipper: "left", deviceIds: ["playfield.art.right-orbit-arrow", "orbit.right.entry", "handoff.right-orbit-entry.inner-guide", "handoff.right-orbit-entry.outer-guide", "orbit.right.outer.lower", "orbit.right.inner.lower", "orbit.right.outer.mid", "orbit.right.inner.mid", "orbit.right.outer.upper", "orbit.right.inner.upper", "boundary.top-arch.right-curve", "boundary.top-arch.center", "boundary.top-arch.left-curve", "orbit.right.exit", "handoff.upper-orbit-gates.right", "wireform.right-orbit-return.upper.rail-left", "wireform.right-orbit-return.upper.rail-right", "wireform.right-orbit-return.lower.rail-left", "wireform.right-orbit-return.lower.rail-right", "wireform.right-orbit-return.exit", "handoff.right-orbit-exit.left-guide", "handoff.right-orbit-exit.right-guide"] },

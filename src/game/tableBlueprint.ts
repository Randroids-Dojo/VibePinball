...
export const silverballSocialBlueprint: TableBlueprint = {
  ...
  shots: [
    { id: "shot.left-orbit", label: "Left orbit", primaryFlipper: "right", deviceIds: ["playfield.art.left-orbit-arrow", "orbit.left.entry", "handoff.left-orbit-entry.inner-guide", "handoff.left-orbit-entry.outer-guide", "orbit.left.outer.lower", "orbit.left.inner.lower", "orbit.left.outer.mid", "orbit.left.inner.mid", "orbit.left.outer.upper", "orbit.left.inner.upper", "boundary.top-arch.left-curve", "boundary.top-arch.center", "boundary.top-arch.right-curve", "orbit.left.exit", "handoff.upper-orbit-gates.left", "handoff.upper-orbit-gates.left.screw-a", "handoff.upper-orbit-gates.left.screw-b", "handoff.upper-orbit-gates.left.hinge-post", "handoff.upper-orbit-gates.left.hinge-post.cap", "handoff.upper-orbit-gates.left.stop-post", "handoff.upper-orbit-gates.left.stop-post.cap", "lane.top.left", "rollover.top.left", "lane.top.left.guide-cover", "lane.top.left.rubber-band", "pop-a"] },

...
export interface TargetDevice extends SensorZone {
  ...
  face: TargetFace;
  lampInsertId: string;
  switchBlades: TargetSwitchBlade[];
  rearStop: Segment;
...
export interface TargetSwitchBlade extends Segment {
  targetId: string;
  kind: "metal";
}
...
export interface TargetBankSwitchRail extends Segment {
  kind: "metal";
  fasteners: TargetBankFrameFastener[];
}
...
export interface TargetBankHardware {
  ...
  switchRail: TargetBankSwitchRail;
  posts: Post[];
}
...
export interface SaucerEjectCoil {
  id: string;
  targetId: string;
  x: number;
  z: number;
  ...
  rodRadius: number;
  bracket: Segment;
  bracketFasteners: SaucerEjectCoilFastener[];
  kind: "coil";
}

export interface SaucerEjectCoilFastener {
  id: string;
  targetId: string;
  x: number;
  z: number;
...
export interface TroughEjectCoil {
  id: string;
  targetId: string;
  x: number;
  z: number;
  ...
  rodRadius: number;
  bracket: Segment;
  bracketFasteners: TroughEjectCoilFastener[];
  kind: "coil";
}

export interface TroughEjectCoilFastener {
  id: string;
  targetId: string;
  x: number;
  z: number;
...
const makeTargetSwitchBlades = (
  targetId: string,
  x: number,
  z: number,
  angle = 0
): TargetSwitchBlade[] => {
  const point = (backOffset: number) => ({
    x: x + Math.sin(angle) * backOffset,
    z: z - Math.cos(angle) * backOffset
  });
  const front = point(0.16);
  const rear = point(0.23);

  return [
    { id: `${targetId}.leaf-switch.front-blade`, targetId, x: front.x, z: front.z, width: 0.28, depth: 0.026, angle, kind: "metal" },
    { id: `${targetId}.leaf-switch.rear-blade`, targetId, x: rear.x, z: rear.z, width: 0.28, depth: 0.026, angle, kind: "metal" }
  ];
};
...
export const silverballSocialBlueprint: TableBlueprint = {
  ...
  laneWalls: withLaneWallFasteners([
    ...
    { id: "orbit.left.outer.lower", x: -3.6, z: 0.02, width: 0.1, depth: 2.22, angle: -0.13, kind: "metal" },
    { id: "orbit.left.outer.mid", x: -3.46, z: -2.1, width: 0.1, depth: 2.1, angle: -0.28, kind: "metal" },
    { id: "orbit.left.outer.link", x: -3.06, z: -3.95, width: 0.1, depth: 1.95, angle: -0.52, kind: "metal" },
    { id: "orbit.left.outer.upper", x: -2.36, z: -5.5, width: 0.1, depth: 1.5, angle: -0.86, kind: "metal" },
    { id: "orbit.left.inner.lower", x: -2.82, z: 0.1, width: 0.1, depth: 1.82, angle: -0.13, kind: "metal" },
    { id: "orbit.left.inner.link-lower", x: -2.66, z: -1.2, width: 0.1, depth: 1.1, angle: -0.24, kind: "metal" },
    { id: "orbit.right.inner.entry", x: 2.94, z: 2.45, width: 0.1, depth: 2.9, angle: 0.03, kind: "metal" },
    { id: "orbit.right.inner.lower", x: 2.82, z: 0.1, width: 0.1, depth: 1.82, angle: 0.13, kind: "metal" },
    { id: "orbit.right.inner.link-lower", x: 2.66, z: -1.2, width: 0.1, depth: 1.1, angle: 0.24, kind: "metal" },
    { id: "orbit.right.outer.lower", x: 3.6, z: 0.02, width: 0.1, depth: 2.22, angle: 0.13, kind: "metal" },
    { id: "orbit.right.outer.mid", x: 3.46, z: -2.1, width: 0.1, depth: 2.1, angle: 0.28, kind: "metal" },
    { id: "orbit.right.outer.link", x: 3.06, z: -3.95, width: 0.1, depth: 1.95, angle: 0.52, kind: "metal" },
    { id: "orbit.right.outer.upper", x: 2.36, z: -5.5, width: 0.1, depth: 1.5, angle: 0.86, kind: "metal" },
  ...
  targetBank: {
    ...
    switchRail: {
      ...
      kind: "metal",
      fasteners: [
        { id: "target-bank.switch-rail.screw-left-outer", targetId: "target-bank.switch-rail", x: -1.34, z: -2.93, radius: 0.028, kind: "metal" },
        { id: "target-bank.switch-rail.screw-left-inner", targetId: "target-bank.switch-rail", x: -0.46, z: -2.93, radius: 0.028, kind: "metal" },
        { id: "target-bank.switch-rail.screw-right-inner", targetId: "target-bank.switch-rail", x: 0.46, z: -2.93, radius: 0.028, kind: "metal" },
        { id: "target-bank.switch-rail.screw-right-outer", targetId: "target-bank.switch-rail", x: 1.34, z: -2.93, radius: 0.028, kind: "metal" }
      ]
    },
    posts: [
      {
  ...
  saucers: [
    {
      ...
      ejectCoil: {
        id: "lock.saucer.eject-coil",
        targetId: "lock.saucer",
        x: 1.58,
        z: -3.72,
        angle: -0.62,
        coilRadius: 0.11,
        ...
        rodLength: 0.52,
        rodRadius: 0.026,
        bracket: { id: "lock.saucer.eject-coil.bracket", x: 1.38, z: -3.54, width: 0.42, depth: 0.08, angle: -0.62, kind: "metal" },
        bracketFasteners: [
          { id: "lock.saucer.eject-coil.bracket.screw-left", targetId: "lock.saucer.eject-coil.bracket", x: 1.24, z: -3.43, radius: 0.026, kind: "metal" },
          { id: "lock.saucer.eject-coil.bracket.screw-right", targetId: "lock.saucer.eject-coil.bracket", x: 1.52, z: -3.66, radius: 0.026, kind: "metal" }
        ],
        kind: "coil"
      },
      holdX: 0.92,
  ...
  drain: {
    ...
    apronLamps: withLampInsertLenses([
      { id: "apron.ball-save-lamp", label: "Save", x: -2.32, z: 6.96, radius: 0.105, angle: 0.03, color: 0x5fd4ff, shape: "bar" },
      { id: "apron.shoot-again-lamp", label: "Again", x: 2.32, z: 6.96, radius: 0.105, angle: -0.03, color: 0xffe08a, shape: "bar" }
    ]),
    drainGuides: [
      {
        id: "drain.left-guide",
    ...
    trough: {
      ...
      ejectCoil: {
        id: "trough.eject-coil",
        targetId: "trough.ball-return",
        x: 1.08,
        z: 7.58,
        angle: -0.58,
        coilRadius: 0.12,
        ...
        rodLength: 0.58,
        rodRadius: 0.028,
        bracket: { id: "trough.eject-coil.bracket", x: 1.2, z: 7.43, width: 0.46, depth: 0.08, angle: -0.58, kind: "metal" },
        bracketFasteners: [
          { id: "trough.eject-coil.bracket.screw-left", targetId: "trough.eject-coil.bracket", x: 1.04, z: 7.54, radius: 0.028, kind: "metal" },
          { id: "trough.eject-coil.bracket.screw-right", targetId: "trough.eject-coil.bracket", x: 1.36, z: 7.32, radius: 0.028, kind: "metal" }
        ],
        kind: "coil"
      },
      walls: [

...
export const silverballSocialBlueprint: TableBlueprint = {
  ...
  shots: [
    { id: "shot.left-orbit", label: "Left orbit", primaryFlipper: "right", deviceIds: ["playfield.art.left-orbit-arrow", "orbit.left.entry", "handoff.left-orbit-entry.inner-guide", "handoff.left-orbit-entry.outer-guide", "orbit.left.outer.lower", "orbit.left.inner.lower", "orbit.left.outer.mid", "orbit.left.inner.mid", "orbit.left.outer.upper", "orbit.left.inner.upper", "boundary.top-arch.left-curve", "boundary.top-arch.center", "boundary.top-arch.right-curve", "orbit.left.exit", "handoff.upper-orbit-gates.left", "lane.top.left", "rollover.top.left", "lane.top.left.guide-cover", "lane.top.left.rubber-band", "pop-a"] },
    { id: "shot.left-ramp", label: "Left ramp", primaryFlipper: "right", deviceIds: ["playfield.art.left-ramp-arrow", "ramp.left", "ramp.left.entry", "ramp.left.entrance-lip", "ramp.left.entrance-lip.screw-a", "ramp.left.entrance-lip.screw-b", "ramp.left.side-wall.left", "ramp.left.side-wall.left.rivet-lower", "ramp.left.side-wall.left.rivet-mid", "ramp.left.side-wall.left.rivet-upper", "ramp.left.side-wall.right", "ramp.left.side-wall.right.rivet-lower", "ramp.left.side-wall.right.rivet-mid", "ramp.left.side-wall.right.rivet-upper", "ramp.left.side-rail.left", "ramp.left.side-rail.left.clamp-lower", "ramp.left.side-rail.left.clamp-mid", "ramp.left.side-rail.left.clamp-upper", "ramp.left.side-rail.right", "ramp.left.side-rail.right.clamp-lower", "ramp.left.side-rail.right.clamp-mid", "ramp.left.side-rail.right.clamp-upper", "ramp.left.cross-brace.lower", "ramp.left.cross-brace.lower.screw-left", "ramp.left.cross-brace.lower.screw-right", "ramp.left.cross-brace.mid", "ramp.left.cross-brace.mid.screw-left", "ramp.left.cross-brace.mid.screw-right", "ramp.left.cross-brace.upper", "ramp.left.cross-brace.upper.screw-left", "ramp.left.cross-brace.upper.screw-right", "ramp.left.support.entry", "ramp.left.support.entry.cap", "ramp.left.support.entry.foot", "ramp.left.support.entry.foot.screw-left", "ramp.left.support.entry.foot.screw-right", "ramp.left.support.entry.collar", "ramp.left.support.entry.saddle", "ramp.left.support.entry.saddle.screw-left", "ramp.left.support.entry.saddle.screw-right", "ramp.left.support.lower", "ramp.left.support.lower.cap", "ramp.left.support.lower.foot", "ramp.left.support.lower.foot.screw-left", "ramp.left.support.lower.foot.screw-right", "ramp.left.support.lower.collar", "ramp.left.support.lower.saddle", "ramp.left.support.lower.saddle.screw-left", "ramp.left.support.lower.saddle.screw-right", "ramp.left.support.mid", "ramp.left.support.mid.cap", "ramp.left.support.mid.foot", "ramp.left.support.mid.foot.screw-left", "ramp.left.support.mid.foot.screw-right", "ramp.left.support.mid.collar", "ramp.left.support.mid.saddle", "ramp.left.support.mid.saddle.screw-left", "ramp.left.support.mid.saddle.screw-right", "ramp.left.support.crest", "ramp.left.support.crest.cap", "ramp.left.support.crest.foot", "ramp.left.support.crest.foot.screw-left", "ramp.left.support.crest.foot.screw-right", "ramp.left.support.crest.collar", "ramp.left.support.crest.saddle", "ramp.left.support.crest.saddle.screw-left", "ramp.left.support.crest.saddle.screw-right", "handoff.ramp-left-entry.flap", "handoff.ramp-left-entry.left-guide", "handoff.ramp-left-entry.right-guide", "ramp.left.exit", "wireform.left-return.upper.rail-left", "wireform.left-return.upper.rail-left.clamp-entry", "wireform.left-return.upper.rail-left.clamp-mid", "wireform.left-return.upper.rail-left.clamp-exit", "wireform.left-return.upper.rail-right", "wireform.left-return.upper.rail-right.clamp-entry", "wireform.left-return.upper.rail-right.clamp-mid", "wireform.left-return.upper.rail-right.clamp-exit", "wireform.left-return.lower.rail-left", "wireform.left-return.lower.rail-left.clamp-entry", "wireform.left-return.lower.rail-left.clamp-mid", "wireform.left-return.lower.rail-left.clamp-exit", "wireform.left-return.lower.rail-right", "wireform.left-return.lower.rail-right.clamp-entry", "wireform.left-return.lower.rail-right.clamp-mid", "wireform.left-return.lower.rail-right.clamp-exit", "wireform.left-return.support.upper", "wireform.left-return.support.upper.cap", "wireform.left-return.support.upper.foot", "wireform.left-return.support.upper.foot.screw-left", "wireform.left-return.support.upper.foot.screw-right", "wireform.left-return.support.upper.collar", "wireform.left-return.support.upper.saddle", "wireform.left-return.support.upper.saddle.screw-left", "wireform.left-return.support.upper.saddle.screw-right", "wireform.left-return.support.mid", "wireform.left-return.support.mid.cap", "wireform.left-return.support.mid.foot", "wireform.left-return.support.mid.foot.screw-left", "wireform.left-return.support.mid.foot.screw-right", "wireform.left-return.support.mid.collar", "wireform.left-return.support.mid.saddle", "wireform.left-return.support.mid.saddle.screw-left", "wireform.left-return.support.mid.saddle.screw-right", "wireform.left-return.support.exit", "wireform.left-return.support.exit.cap", "wireform.left-return.support.exit.foot", "wireform.left-return.support.exit.foot.screw-left", "wireform.left-return.support.exit.foot.screw-right", "wireform.left-return.support.exit.collar", "wireform.left-return.support.exit.saddle", "wireform.left-return.support.exit.saddle.screw-left", "wireform.left-return.support.exit.saddle.screw-right", "wireform.left-return.exit", "handoff.ramp-left-exit.left-guide", "handoff.ramp-left-exit.right-guide"] },
    { id: "shot.center-bank", label: "Center target bank", primaryFlipper: "either", deviceIds: ["playfield.art.social-sweep", "target-bank.social", "target-bank.frame-top-rail", "target-bank.frame-top-rail.screw-a", "target-bank.frame-top-rail.screw-b", "target-bank.frame-bottom-rail", "target-bank.frame-bottom-rail.screw-a", "target-bank.frame-bottom-rail.screw-b", "target-bank.frame-left-cheek", "target-bank.frame-left-cheek.screw-a", "target-bank.frame-left-cheek.screw-b", "target-bank.frame-right-cheek", "target-bank.frame-right-cheek.screw-a", "target-bank.frame-right-cheek.screw-b", "target-bank.divider-1", "target-bank.divider-1.screw-a", "target-bank.divider-1.screw-b", "target-bank.divider-2", "target-bank.divider-2.screw-a", "target-bank.divider-2.screw-b", "target-bank.divider-3", "target-bank.divider-3.screw-a", "target-bank.divider-3.screw-b", "target-bank.divider-4", "target-bank.divider-4.screw-a", "target-bank.divider-4.screw-b", "target-bank.post-left-upper", "target-bank.post-left-upper.cap", "target-bank.post-left-lower", "target-bank.post-left-lower.cap", "target-bank.post-right-upper", "target-bank.post-right-upper.cap", "target-bank.post-right-lower", "target-bank.post-right-lower.cap", "target-bank-1", "target-bank-1.face", "insert.social-s", "target-bank-1.mount-plate", "target-bank-1.mount-screw-left", "target-bank-1.mount-screw-right", "target-bank-1.rear-stop", "target-bank-2", "target-bank-2.face", "insert.social-o", "target-bank-2.mount-plate", "target-bank-2.mount-screw-left", "target-bank-2.mount-screw-right", "target-bank-2.rear-stop", "target-bank-3", "target-bank-3.face", "insert.social-c", "target-bank-3.mount-plate", "target-bank-3.mount-screw-left", "target-bank-3.mount-screw-right", "target-bank-3.rear-stop", "target-bank-4", "target-bank-4.face", "insert.social-i", "target-bank-4.mount-plate", "target-bank-4.mount-screw-left", "target-bank-4.mount-screw-right", "target-bank-4.rear-stop", "target-bank-5", "target-bank-5.face", "insert.social-a", "target-bank-5.mount-plate", "target-bank-5.mount-screw-left", "target-bank-5.mount-screw-right", "target-bank-5.rear-stop"] },
    { id: "shot.lock-saucer", label: "Lock saucer", primaryFlipper: "left", deviceIds: ["playfield.art.lock-label", "lock.saucer", "lock.saucer.cup", "lock.saucer.back-wall", "lock.saucer.left-entry-wall", "lock.saucer.right-entry-wall", "lock.saucer.left-post", "lock.saucer.right-post", "lock.saucer.eject-guide"] },
    { id: "shot.right-orbit", label: "Right orbit", primaryFlipper: "left", deviceIds: ["playfield.art.right-orbit-arrow", "orbit.right.entry", "handoff.right-orbit-entry.inner-guide", "handoff.right-orbit-entry.outer-guide", "orbit.right.outer.lower", "orbit.right.inner.lower", "orbit.right.outer.mid", "orbit.right.inner.mid", "orbit.right.outer.upper", "orbit.right.inner.upper", "boundary.top-arch.right-curve", "boundary.top-arch.center", "boundary.top-arch.left-curve", "orbit.right.exit", "handoff.upper-orbit-gates.right", "wireform.right-orbit-return.upper.rail-left", "wireform.right-orbit-return.upper.rail-left.clamp-entry", "wireform.right-orbit-return.upper.rail-left.clamp-mid", "wireform.right-orbit-return.upper.rail-left.clamp-exit", "wireform.right-orbit-return.upper.rail-right", "wireform.right-orbit-return.upper.rail-right.clamp-entry", "wireform.right-orbit-return.upper.rail-right.clamp-mid", "wireform.right-orbit-return.upper.rail-right.clamp-exit", "wireform.right-orbit-return.lower.rail-left", "wireform.right-orbit-return.lower.rail-left.clamp-entry", "wireform.right-orbit-return.lower.rail-left.clamp-mid", "wireform.right-orbit-return.lower.rail-left.clamp-exit", "wireform.right-orbit-return.lower.rail-right", "wireform.right-orbit-return.lower.rail-right.clamp-entry", "wireform.right-orbit-return.lower.rail-right.clamp-mid", "wireform.right-orbit-return.lower.rail-right.clamp-exit", "wireform.right-orbit-return.support.upper", "wireform.right-orbit-return.support.upper.cap", "wireform.right-orbit-return.support.upper.foot", "wireform.right-orbit-return.support.upper.foot.screw-left", "wireform.right-orbit-return.support.upper.foot.screw-right", "wireform.right-orbit-return.support.upper.collar", "wireform.right-orbit-return.support.upper.saddle", "wireform.right-orbit-return.support.upper.saddle.screw-left", "wireform.right-orbit-return.support.upper.saddle.screw-right", "wireform.right-orbit-return.support.mid", "wireform.right-orbit-return.support.mid.cap", "wireform.right-orbit-return.support.mid.foot", "wireform.right-orbit-return.support.mid.foot.screw-left", "wireform.right-orbit-return.support.mid.foot.screw-right", "wireform.right-orbit-return.support.mid.collar", "wireform.right-orbit-return.support.mid.saddle", "wireform.right-orbit-return.support.mid.saddle.screw-left", "wireform.right-orbit-return.support.mid.saddle.screw-right", "wireform.right-orbit-return.support.exit", "wireform.right-orbit-return.support.exit.cap", "wireform.right-orbit-return.support.exit.foot", "wireform.right-orbit-return.support.exit.foot.screw-left", "wireform.right-orbit-return.support.exit.foot.screw-right", "wireform.right-orbit-return.support.exit.collar", "wireform.right-orbit-return.support.exit.saddle", "wireform.right-orbit-return.support.exit.saddle.screw-left", "wireform.right-orbit-return.support.exit.saddle.screw-right", "wireform.right-orbit-return.exit", "handoff.right-orbit-exit.left-guide", "handoff.right-orbit-exit.right-guide"] },
    { id: "shot.skill-shot", label: "Skill shot", primaryFlipper: "plunger", deviceIds: ["trough.shooter-feed-guide", "boundary.shooter-arch.top", "boundary.top-arch.right-curve", "lane.top.right", "rollover.top.right", "lane.top.right.guide-cover", "lane.top.right.rubber-band", "lane.shooter.skill", "rollover.shooter.skill", "lane.shooter.skill.guide-cover", "lane.shooter.skill.rubber-band", "insert.skill-shot", "shooter.one-way-gate", "shooter.one-way-gate.hinge-post", "shooter.one-way-gate.stop-post"] }
  ]
};
